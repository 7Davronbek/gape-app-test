  ...
  return (
    <div className="Gallery">
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-8 mb-4 topCol">
            <h2>“Jorem ipsum dolor sit amet, consectetur adipiscing elit.”</h2>
          ...
          <div className="col-lg-7 mb-4 topCol">
            <h3>“Jorem ipsum dolor sit amet, consectetur adipiscing elit.”</h3>
